...
function nsbe_support_scripts() {
    ...
    wp_enqueue_style( 'owl_css', get_template_directory_uri() . '/css/owl.carousel.css' ); 
    wp_enqueue_style( 'theme_default_css', get_template_directory_uri() . '/css/owl.theme.default.min.css' ); 
    wp_enqueue_style( 'bootstrap_css', get_template_directory_uri() . '/css/bootstrap.css' );
    wp_enqueue_style( 'product_slider_css', get_template_directory_uri() . '/css/product-slider.css' );
    ...
    wp_enqueue_script( 'slidy_js', get_template_directory_uri() . '/js/myslider.js');
        
    wp_enqueue_script( 'popper_js', get_template_directory_uri() . '/js/popper.min.js');
    wp_enqueue_script( 'owl_js', get_template_directory_uri() . '/js/owl.carousel.js');
    ...
    wp_enqueue_script( 'autoscroll_js', get_template_directory_uri() . '/js/autoscroll.js');
